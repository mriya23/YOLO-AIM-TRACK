...
class LunarGUI(ctk.CTk):
    ...
    def _build_page_combat(self):
        ...
        card_trig = self._create_card(col2, "Triggerbot", "trigger_enabled")
    ...
    def _on_start(self):
        ...
        self.after(2000, self._launch_executor) # Wait for SHM
    ...
    def _launch_executor(self):
        ...
        if os.path.exists(exe_path):
             self.proc_cpp = subprocess.Popen([exe_path], creationflags=subprocess.CREATE_NEW_CONSOLE)
